...
export default function AnimatedHeroSection() {
  return (
    <section className="items-center pt-28 h-[65vh] csz:h-[80vh] sm:h-[90vh] md:h-[100vh] lg:h-[110vh] 3xl:h-[43.75rem] overflow-hidden relative">
          <div className="text-white w-full text-center text-5xl flex flex-col">
            ...
            <div className="animate-float absolute right-[-7.5rem] csz:right-[-9.375rem] md:right-[-12.5rem]  lg:right-[-15.625rem] max-csxxs:top-60 top-52 xl:right-[-9.375rem]">
